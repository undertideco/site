  ...
  return (
    <Layout>
      ...
      <Hero>
        ...
        <BodyText>
          Software has become common sense. To retain and grow your customer
          base in a world full of options, a sound business plan is not enough.
        </BodyText>
        <BodyText>
      ...
      <SkillsContainer>
        ...
        <BodyText>
          Regardless of your size, we have our technical resources ready for
          you.
        </BodyText>
        <SkillGrid>
          <Skill>
